...
public interface DAO<T> {
     ...
     */
    Optional<T> get(String id) throws SQLException, NamingException, ClassNotFoundException;
     ...
     */
    void save(T t) throws SQLException, NamingException, ClassNotFoundException;
     ...
     */
    void update(T t, String id) throws SQLException, NamingException, ClassNotFoundException;
     ...
     * @param t L'oggetto contenente i nuovi dati da salvare
     */
    void update(T t) throws NamingException, ClassNotFoundException, SQLException;
     ...
     */
    void delete(T t) throws NamingException, ClassNotFoundException, SQLException;
}